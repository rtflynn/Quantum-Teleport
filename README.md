...
Therefore if we measure a 0, we know that q2 is in the state we want.  If we measure a 1, then we can get q2 into the state we want by sending it through a Z gate.
